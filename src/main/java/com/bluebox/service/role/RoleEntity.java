...
public class RoleEntity extends BaseEntity {
    ...
    @ManyToMany
    @JoinTable(name = "roles_permissions", joinColumns = @JoinColumn(name = "role_id", referencedColumnName = "pk_id"), inverseJoinColumns = @JoinColumn(name = "permission_id", referencedColumnName = "pk_id"))
    private Collection<PermissionEntity> privileges;
